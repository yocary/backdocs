 ...
 */
package com.documentitos.commons;
...
public class CommonController<E, S extends CommonSvc<E>, V extends CommonValidatorSvc<E>> {
    ...
    @GetMapping
    @ApiOperation(value = "Consulta el listado de objetos de Documentitos")
    public ResponseEntity<?> findAll(@RequestHeader(name = "Accept-Languaje", required = false) Locale locale){
        return ResponseEntity.ok().body(service.findAll());
    }
    
    @GetMapping("/{id}")
    @ApiOperation(value = "Consulta un objeto especifico de Documentitos")
    ...
    @PostMapping
    @ApiOperation(value = "Guarda la información de un objeto en Documentitos")
    ...
    @DeleteMapping("/{id}")
    @ApiOperation(value = "Elimina la infirmación de un objeto en Documentitos")
